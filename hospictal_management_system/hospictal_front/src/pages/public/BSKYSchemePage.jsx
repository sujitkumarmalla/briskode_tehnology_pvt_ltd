      ...
      <main className="flex-1">
        ...
        <section className="bg-[#1b365d] text-white py-16 px-4 sm:px-6 lg:px-8 border-b border-blue-900">
          <div className="max-w-7xl mx-auto space-y-3">
            ...
            <p className="text-xs sm:text-sm text-slate-300 max-w-2xl">
              Capital Public Seva Hospital is an approved empanelled hospital offering 100% cashless medical and surgical treatment under Pradhan Mantri Jan Arogya Yojana (PM-JAY).
            </p>
          </div>
        </section>
        ...
        <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="bg-white p-8 rounded-3xl border border-blue-200 shadow-xl space-y-6">
            <h2 className="text-2xl font-extrabold text-slate-900">Ayushman PM-JAY Coverage Benefits at Capital Public Seva Hospital</h2>
